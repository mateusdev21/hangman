...
<div class="card p-4">
    <div class="card-body">
        <div class="row">
            <div class="d-flex flex-column col-md-3 text-center pt-5">
                <div class="mb-auto p-2">
                    <p style="color: white;" class="align-middle"><strong>Dead Counter = <span id="life" style="color: #B84D4D;"></span> Life Remaining</strong></p>
                </div>
                <div class="p-2">
                    <a href="/hangman" class="btn btn-secondary p-2 text-uppercase"><i class="fas fa-home"></i><strong>menu</strong></a>
                </div>
            </div>
            <div class="col-md-9 text-center pt-5">
                ...
                <p class="wrong-feedback" style="color: #B84D4D; display: none"><strong>WRONG!</strong></p>
                <p class="correct-feedback" style="color: green; display: none"><strong>CORRECT!</strong></p>
                <button class="btn btn-success mt-5 reload" onclick="location.reload()" style="display: none;"><strong>RELOAD</strong></button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function lifeDecrease() {
        ...
        $("#life").text(life);
        if (life <= 0) {
            alert("YOU LOSE! The answer is " + word);
